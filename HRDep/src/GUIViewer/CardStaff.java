...
public class CardStaff extends JFrame {
	...
	public CardStaff() {
		...
		JLabel lblNewLabel_4 = new JLabel("Ïîñàäà");
		...
		JLabel lblNewLabel_5 = new JLabel("Ñòðóêòóðíèé ï³äðîçä³ë");
		...
		JLabel lblNewLabel_6 = new JLabel("Òåëåôîí ìîá.");
		...
		JLabel lblNewLabel_7 = new JLabel("Òåëåôîí äîì.");
		...
		JLabel lblNewLabel_8 = new JLabel("²ÍÍ");
		...
		JLabel lblNewLabel_9 = new JLabel("Äàòà ïðèíÿòòÿ íà ðîáîòó");
		...
		JLabel lblNewLabel_10 = new JLabel("Ãðîìàäÿíñòâî");
		...
		JLabel lblNewLabel_11 = new JLabel("Äîìàøíÿ àäðåñà");
		...
		JLabel lblNewLabel_13 = new JLabel("Äàòà íàðîäæåííÿ");
		...
		JLabel lblNewLabel_14 = new JLabel("Ñ³ìåéíå ïîëîæåííÿ");
		...
		JRadioButton manNewRadioButton = new JRadioButton("×îë.");
		...
		JRadioButton womanRadioButton = new JRadioButton("Æ³í.");
		...
		JLabel lblNewLabel = new JLabel("Ïðè÷èíà çâ³ëüíåííÿ");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 13));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(80, 28, 213, 14);
		panelDismiss.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Äàòà çâ³ëüíåííÿ");
		...
		JLabel lblNewLabel_2 = new JLabel("Íîìåð ïðèêàçó");
		...
		JLabel lblNewLabel_3 = new JLabel("Äàòà ïðèêàçó íà çâ³ëüíåííÿ");
		...
		JButton dismissButton = new JButton("Çâ³ëüíèòè");
		...
		JButton card = new JButton("Çàãàëüí³ â³äîìîñò³");
		...
		JButton work = new JButton("Òðóäîâà ä³ÿëüí³ñòü");
		...
		JButton passport = new JButton("Ïàñïîðòí³ äàí³");
		...
		JButton education = new JButton("Îñâ³òà");
		...
		JButton save = new JButton("Çáåðåãòè");
